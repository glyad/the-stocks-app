...
```ts
import { defineComponents, IgcCardComponent, IgcNavbarComponent } from 'igniteui-webcomponents';
...
<igc-grid-lite-column field="name" header="Name"
  >{/* no width — fills remaining space */}</igc-grid-lite-column
>
```
