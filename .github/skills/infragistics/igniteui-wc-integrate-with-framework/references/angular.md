...
@Component({
  ...
  template: ` <igc-button variant="contained">Click me</igc-button> `
})
...
@Component({
  ...
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  template: `
    <igc-button #myButton variant="contained" (click)="handleClick($event)"> Click me </igc-button>
...
@Component({
  ...
  standalone: true,
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  template: ` <igc-combo [data]="items"></igc-combo> `
})
export class MyComponent {
  items = [
